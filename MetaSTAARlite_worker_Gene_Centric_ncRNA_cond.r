...
save(ncRNA_sumstat,file=paste0(output_path,output_file_name,"_sumstat.Rdata"),compress = "xz")
save(ncRNA_cov,file=paste0(output_path,output_file_name,"_cov.Rdata"),compress = "xz")
save(ncRNA_cov_cond,file=paste0(output_path,output_file_name,"_cov_cond.Rdata"),compress = "xz")
